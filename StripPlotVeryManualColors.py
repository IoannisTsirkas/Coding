...
ax = sns.stripplot(data=clipboardData, size=1, zorder=0, palette=custom_palette)
# The size parameter above controls the size of the dots. Default is 5.
sns.boxplot(data=clipboardData, fliersize=0, showbox=0, showcaps=1, whis=0, color='0', width=0.5, linewidth=1)
sns.boxplot(data=clipboardData, fliersize=0, showbox=1, showcaps=0, whis=0, color='0', width=0.001, linewidth=1)

plt.ylabel('Normalized median nuclear ring intensity', fontsize=18)
